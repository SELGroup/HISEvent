"""
    结构熵极小化算法，包含：
        ...
        - 三维结构熵极小化算法
"""
from algorithm.priority_tree import compute_structural_entropy_of_node, PriorityTree
from algorithm.tree_node import TreeNode
from algorithm.two_id import TwoID
